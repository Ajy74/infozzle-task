...
class ConfirmPasswordInput extends StatelessWidget {
  ...
  const ConfirmPasswordInput({super.key, required this.focusNode});
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          validator: (value) {
            ...
            if (context.read<RegisterCubit>().password != value) {
              return 'Confirm password and password should same';
            }
